...
categories:
  - 撸羊毛
copyright: true
index_img: 'https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/img/15.jpg'
banner_img: 'https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/img/15.jpg'
abbrlink: 74e90c90
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-52.png "界面")


点击<kbd>Click me</kbd>


![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-53.png)

点击登入,允许(此时需要你的谷歌账号授权,如果你觉得这对你的账号造成了危险,可以换一个不常用的谷歌账号,反正我个人使用时没有问题)

![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-54.png)
获取密钥:
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-55.png)

进入希望分享的文件夹,比如 `Public`


![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-56.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-57.png)


![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-58.png)

确定，回到DNS，添加A记录，名字为刚刚绑定的那个，ip地址请去我博客-关于界面查看所有CFIPv4地址，这里比较推荐1.0.0.* CN2线路，速度不错。

![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-59.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-60.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-61.png)



![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-62.png)

![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-63.png)

![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-64.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-65.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-66.png)
...
![upload successful](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-78.png)
