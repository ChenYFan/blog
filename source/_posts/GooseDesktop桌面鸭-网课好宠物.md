...
index_img: https://assets.cyfan.top/file/CYF-PicBed/pic/cover/5.png
banner_img: https://assets.cyfan.top/file/CYF-PicBed/pic/cover/5.png
---
# GooseDesktop
...
- 会随机拖出一些~~治愈人心~~毒鸡汤(可以自定义)
	![](https://assets.cyfan.top/file/CYF-PicBed/pic/post/10.gif)
- 会随机拖出一些你珍藏多年的图片(可以自定义)
	![](https://assets.cyfan.top/file/CYF-PicBed/pic/post/11.gif)
...
试着想一下,这是不是特别适合网课的时候玩呢<img src="https://assets.cyfan.top/file/CYF-PicBed/pic/moji/huaji.png">?

# 配置

下载下来,打开来应该是这样:

![upload successful](https://assets.cyfan.top/file/CYF-PicBed/pic/post/pasted-91.png)

进入 `Assets`:


![upload successful](https://assets.cyfan.top/file/CYF-PicBed/pic/post/pasted-92.png)

`Images\memes`,里面是鸭子随机拖出来的图片,我的版本里已经预置了10张美图+2张脖子以下不能看.jpg<img src="https://assets.cyfan.top/file/CYF-PicBed/pic/moji/bx.png">.注意不要在家长旁边打开!当然你也可以替换成别的,文件名随意.

在 `/Assets/Text/NotepadMessages` 里是鸭子拖出来的文本,里面已经预置了1222句毒鸡汤,句句治愈人心<img src="https://assets.cyfan.top/file/CYF-PicBed/pic/moji/yhuaji.png">.当然你也可以替换成别的,文件名随意.
