...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629135012.jpg)

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/stick_7.png)

由于hexo基于nodejs+git，手机无法更新；同时如果换了台电脑，hexo就要重装。这种事情hexo用户应该体会得到，我也就不多说了。![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/%E4%B8%AD%E5%88%80.png)

那么，hexo用户如何进行在线更新呢？

正常来讲，**服务器法** 最直接，但也是最没用的。用服务器就意味着丧失了hexo的最优点-节省开支。当然，Hexo+Nginx+HexoAdmin确实可以实现很棒的书写环境，但是与其这么麻烦你还不如直接用Typecho&Wordpress呢。![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/%E4%B8%8D%E9%AB%98%E5%85%B4.png)

曾经在 [Hexo官方](https://hexo.io) 上看过 [利用Travis-ci自动部署GithubPages](https://hexo.io/zh-cn/docs/github-pages) 不过我一看到这么多步骤直接 ~~**萎缩**~~ ![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/%E6%8A%95%E9%99%8D.png) 

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629140241.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629140732.jpg)
...
嗯，![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/stick_38.png)

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629141017.jpg)

我 `git add .` 了一下,它运算了半小时, `git commit` 又花了半小时,幸好`git push` 是打包上去的,不然我估计又要花半个小时.

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629141259.jpg)

结果戏剧性的是,当我去看travis-ci部署记录时,我发现:

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629141542.jpg)

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/tx.png)
...
前往 [https://travis-ci.org] 用Github账号注册 **注意了啊,注意了啊,** 是 `.org` 而不是 `.com` ! 鬼知道我在这上面浪费了多少时间! `travis-ci.org` 是免费给公开repo部署的,`travis-ci.com` 是收费的,但是 `travis-ci.com` 却是可以绑定并免费部署公开Repo的.最有问题的是这两个网站其中一个绑定repo后,另一个就不能绑定了!! 害得我以为是缓存搞出来的事,搞了半天没解决,一看地址栏人都傻了.![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/tx.png)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629142607.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629142812.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629143305.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629145235.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629145630.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629150414.jpg)

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629150525.jpg)

![麻烦无视左上角的亮度调节](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629150600.jpg)

![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/postpic/20200629152935.jpg)
...
![](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/moji/stick_54.png)
