...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/pasted-0.png "Hexo-Admin")
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-1.png "预览")

爽翻了.

甚至上下滑动它都会自动同步:

![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/1.gif "Hexo-Admin上下滑动自动同步")

### 草稿制


![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-0.png "草稿")


![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-2.png)


![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-3.png)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-4.png)
...
<img class="alingleft" src="https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-5.png">
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-6.png)

点击 `Setup authentification here.`


![输入](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-7.png)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-8.png)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-9.png)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/pasted-10.png)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/2.gif)

### 不能拖拽放入图片

![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/3.gif)
...
![图片](https://npm.elemecdn.com/chenyfan-oss@1.0.0/pic/post/4.gif)
